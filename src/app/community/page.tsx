...
import { GlobeIcon, MessageIcon, HeartIcon, ShieldCheckIcon } from "@/components/Icons";
...
export const metadata: Metadata = {
  title: "Community Hub",
  description: "City forums, peer vouches and emergency hospitality alerts from real 4dnomads members -- ask local questions and see who's trusted whom.",
};

export default async function CommunityPage() {
  // 12 rather than 3: vouches are the lead content of this screen now, not a
  // sidebar teaser.
  const [topics, alerts, vouches] = await Promise.all([getForumTopics(), getEmergencyAlerts(), getRecentVouches(12)]);
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          <div>
            {/* Vouches lead: they name two real people and a real stay, which
                is the most social thing this platform produces. A forum topic
                list on an empty board reads as an abandoned product. */}
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>
                <ShieldCheckIcon size={22} style={{ color: "var(--terracotta-500)" }} /> Recent Vouches
              </h2>
            </div>

            <VouchFeed vouches={vouches} />
